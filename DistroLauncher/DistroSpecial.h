...
namespace DistroSpecial
{
	...
	const TCHAR UserlandDownloadURL[] = _T("https://dl-cdn.alpinelinux.org/alpine/v3.23/releases/x86_64/alpine-minirootfs-3.23.3-x86_64.tar.gz");
	const std::wstring UserlandChecksum = L"42D0E6D8DE5521E7BF92E075E032B5690C1D948FA9775EFA32A51A38B25460FB";
}
